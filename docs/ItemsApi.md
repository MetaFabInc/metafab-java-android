...
String collectionId = null; // String | Any collection id within the MetaFab platform.
...
------------- | ------------- | ------------- | -------------
 **collectionId** | **String**| Any collection id within the MetaFab platform. | [default to null]
