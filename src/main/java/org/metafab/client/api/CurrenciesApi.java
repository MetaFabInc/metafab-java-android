...
public class CurrenciesApi {
  ...
  * Returns the current currency balance of the provided wallet address or or the wallet address associated with the provided walletId.
   ...
   * @return BigDecimal
  */
  public BigDecimal getCurrencyBalances (String currencyId, String address, String walletId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'currencyId' is set
    if (currencyId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'currencyId' when calling getCurrencyBalances",
        new ApiException(400, "Missing the required parameter 'currencyId' when calling getCurrencyBalances"));
    }
  ...
  */
  public void getCurrencyBalances (String currencyId, String address, String walletId, final Response.Listener<BigDecimal> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
