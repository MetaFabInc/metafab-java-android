...
public class CurrenciesApi {
  ...
  */
  public TransactionModel batchTransferCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, BatchTransferCurrencyRequest batchTransferCurrencyRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling batchTransferCurrency",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling batchTransferCurrency"));
    }
   ...
   * Batch transfer currency
   * Transfers multiple amounts of currency to multiple provided wallet addresses or wallet addresses associated with the provided walletIds. You may also provide a combination of addresses and walletIds in one request, the proper receipients will be automatically determined, with &#x60;addresses&#x60; getting &#x60;amounts&#x60; order priority first.  Optional references may be included for the transfer. References are useful for identifying transfers intended to pay for items, trades, services and more.
   * @param currencyId Any currency id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet.   * @param batchTransferCurrencyRequest 
  */
  public void batchTransferCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, BatchTransferCurrencyRequest batchTransferCurrencyRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = batchTransferCurrencyRequest;
  ...
  * Removes (burns) the provided amount of currency from the authenticating game or players wallet. The currency amount is permanently removed from the circulating supply of the currency.
   ...
   * @return TransactionModel
  */
  public TransactionModel burnCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, BurnCurrencyRequest burnCurrencyRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling burnCurrency",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling burnCurrency"));
    }
  ...
  */
  public void burnCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, BurnCurrencyRequest burnCurrencyRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = burnCurrencyRequest;
  ...
  */
  public CreateCurrency200Response createCurrency (String xAuthorization, String xWalletDecryptKey, CreateCurrencyRequest createCurrencyRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling createCurrency",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling createCurrency"));
    }
   ...
   * Create currency
   * Creates a new game currency and deploys an ERC20 token contract on behalf of the authenticating game&#39;s primary wallet. The deployed ERC20 contract is preconfigured to fully support bridging across blockchains, batched transfers and gasless transactions on any supported blockchain as well as full support for gasless transactions from player managed wallets.
   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param createCurrencyRequest 
  */
  public void createCurrency (String xAuthorization, String xWalletDecryptKey, CreateCurrencyRequest createCurrencyRequest, final Response.Listener<CreateCurrency200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = createCurrencyRequest;
  ...
  */
   ...
   * Get currency balance
   * Returns the current currency balance of the provided wallet address or or the wallet address associated with the provided walletId.
   * @param currencyId Any currency id within the MetaFab platform.   * @param address A valid EVM based address. For example, &#x60;0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D&#x60;.   * @param walletId Any wallet id within the MetaFab platform.
  */
  ...
  * Grants the provided role for the currency to the provided address or address associated with the provided walletId. Granted roles give different types of authority on behalf of the currency for specific players, addresses, or contracts to perform different types of permissioned currency operations.
   ...
   * @return TransactionModel
  */
  public TransactionModel grantCurrencyRole (String currencyId, String xAuthorization, String xWalletDecryptKey, GrantCurrencyRoleRequest grantCurrencyRoleRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling grantCurrencyRole",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling grantCurrencyRole"));
    }
  ...
  */
  public void grantCurrencyRole (String currencyId, String xAuthorization, String xWalletDecryptKey, GrantCurrencyRoleRequest grantCurrencyRoleRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = grantCurrencyRoleRequest;
  ...
  * Creates (mints) the provided amount of currency to the provided wallet address or wallet address associated with the provided walletId.
   ...
   * @return TransactionModel
  */
  public TransactionModel mintCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, MintCurrencyRequest mintCurrencyRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling mintCurrency",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling mintCurrency"));
    }
   ...
   * Mint currency
   * Creates (mints) the provided amount of currency to the provided wallet address or wallet address associated with the provided walletId.
   * @param currencyId Any currency id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param mintCurrencyRequest 
  */
  public void mintCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, MintCurrencyRequest mintCurrencyRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = mintCurrencyRequest;
  ...
  * Revokes the provided role for the currency to the provided address or address associated with the provided walletId.
   ...
   * @return TransactionModel
  */
  public TransactionModel revokeCurrencyRole (String currencyId, String xAuthorization, String xWalletDecryptKey, RevokeCollectionRoleRequest revokeCollectionRoleRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling revokeCurrencyRole",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling revokeCurrencyRole"));
    }
  ...
  */
  public void revokeCurrencyRole (String currencyId, String xAuthorization, String xWalletDecryptKey, RevokeCollectionRoleRequest revokeCollectionRoleRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = revokeCollectionRoleRequest;
  ...
  * Sets the recipient address, basis points, fixed amount and cap amount for a currency&#39;s fees.
   ...
   * @return TransactionModel
  */
  public TransactionModel setCurrencyFees (String currencyId, String xAuthorization, String xWalletDecryptKey, SetCurrencyFeesRequest setCurrencyFeesRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling setCurrencyFees",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling setCurrencyFees"));
    }
   ...
   * Set currency fees
   * Sets the recipient address, basis points, fixed amount and cap amount for a currency&#39;s fees.
   * @param currencyId Any currency id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param setCurrencyFeesRequest 
  */
  public void setCurrencyFees (String currencyId, String xAuthorization, String xWalletDecryptKey, SetCurrencyFeesRequest setCurrencyFeesRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = setCurrencyFeesRequest;
  ...
  * Transfers an amount of currency to the provided wallet address or wallet address associated with the provided walletId. If you want to transfer to multiple wallets with different amounts and optional references in one API request, please see the Batch transfer currency documentation.  An optional reference may be included for the transfer. References are useful for identifying transfers intended to pay for items, trades, services and more.
   ...
   * @return TransactionModel
  */
  public TransactionModel transferCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, TransferCurrencyRequest transferCurrencyRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling transferCurrency",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling transferCurrency"));
    }
  ...
  */
  public void transferCurrency (String currencyId, String xAuthorization, String xWalletDecryptKey, TransferCurrencyRequest transferCurrencyRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = transferCurrencyRequest;
