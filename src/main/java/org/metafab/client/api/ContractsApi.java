...
public class ContractsApi {
  ...
  */
   ...
   * Read contract data
   * Oftentimes you&#39;ll want to query and retrieve some data from a contract. This is incredibly easy to do for any contract deployed through MetaFab.  Using this endpoint, you can get the data returned by any readable function listed in a contracts ABI. This could be things like querying the totalSupply of a currency contract, the number of owners of an items contract, and more.
   * @param contractId Any contract id within the MetaFab platform.   * @param func A contract function name. This can be any valid function from the the ABI of the contract you are interacting with. For example, &#x60;balanceOf&#x60;.   * @param args A comma seperated list of basic data type arguments. This is optional and only necessary if the function being invoked requires arguments per the contract ABI. For example, &#x60;123,\&quot;Hello\&quot;,false&#x60;.
  */
  ...
  * Transfer ownership and control of a MetaFab deployed smart contract to another wallet you control. Transferring control does not disrupt your usage of MetaFab APIs and can be done so without causing any service outages for your game. The new owner wallet will have full control over any relevant item collections and marketplace related pages this contract may be associated with, such as for MetaFab item or NFT contracts.  Your game&#39;s custodial wallet will retain a &#x60;MANAGER_ROLE&#x60; on your contracts, allowing you to still use MetaFab APIs without issue while you retain full contract ownership and the contract&#39;s administrator role. If ever you want eject from using the MetaFab APIs but still retain your deployed smart contracts, you can revoke the &#x60;MANAGER_ROLE&#x60; from your game&#39;s custodial wallet address for your contract. We do not lock you into our systems.  Please be certain that the wallet address you transfer ownership to is one you control. Once ownership and admin permissions are transferred, your game&#39;s custodial wallet no longer has permission to reassign ownership or administrative priveleges for your contract.
   ...
   * @param transferContractOwnershipRequest 
   * @return TransactionModel
  */
  public TransactionModel transferContractOwnership (String contractId, String xAuthorization, String xWalletDecryptKey, TransferContractOwnershipRequest transferContractOwnershipRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = transferContractOwnershipRequest;
    // verify the required parameter 'contractId' is set
    if (contractId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'contractId' when calling transferContractOwnership",
        new ApiException(400, "Missing the required parameter 'contractId' when calling transferContractOwnership"));
    }
    // verify the required parameter 'xAuthorization' is set
    if (xAuthorization == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xAuthorization' when calling transferContractOwnership",
        new ApiException(400, "Missing the required parameter 'xAuthorization' when calling transferContractOwnership"));
    }
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling transferContractOwnership",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling transferContractOwnership"));
    }
    // verify the required parameter 'transferContractOwnershipRequest' is set
    if (transferContractOwnershipRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'transferContractOwnershipRequest' when calling transferContractOwnership",
        new ApiException(400, "Missing the required parameter 'transferContractOwnershipRequest' when calling transferContractOwnership"));
    }

    // create path and map variables
    String path = "/v1/contracts/{contractId}/owners".replaceAll("\\{" + "contractId" + "\\}", apiInvoker.escapeString(contractId.toString()));
   ...
   * Transfer contract ownership
   * Transfer ownership and control of a MetaFab deployed smart contract to another wallet you control. Transferring control does not disrupt your usage of MetaFab APIs and can be done so without causing any service outages for your game. The new owner wallet will have full control over any relevant item collections and marketplace related pages this contract may be associated with, such as for MetaFab item or NFT contracts.  Your game&#39;s custodial wallet will retain a &#x60;MANAGER_ROLE&#x60; on your contracts, allowing you to still use MetaFab APIs without issue while you retain full contract ownership and the contract&#39;s administrator role. If ever you want eject from using the MetaFab APIs but still retain your deployed smart contracts, you can revoke the &#x60;MANAGER_ROLE&#x60; from your game&#39;s custodial wallet address for your contract. We do not lock you into our systems.  Please be certain that the wallet address you transfer ownership to is one you control. Once ownership and admin permissions are transferred, your game&#39;s custodial wallet no longer has permission to reassign ownership or administrative priveleges for your contract.
   * @param contractId Any contract id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param transferContractOwnershipRequest 
  */
  public void transferContractOwnership (String contractId, String xAuthorization, String xWalletDecryptKey, TransferContractOwnershipRequest transferContractOwnershipRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = transferContractOwnershipRequest;
    ...
    // create path and map variables
    String path = "/v1/contracts/{contractId}/owners".replaceAll("\\{format\\}","json").replaceAll("\\{" + "contractId" + "\\}", apiInvoker.escapeString(contractId.toString()));
  ...
  * In rare circumstances, you may need to upgrade the underlying trusted forwarder contract address attached to your game&#39;s contracts. Using this endpoint, you can provide a new trusted forwarder contract address to assign to any of your contracts that implement the &#x60;upgradeTrustedForwarder&#x60; function.
   ...
   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.
   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.
   * @param upgradeContractTrustedForwarderRequest 
   * @return TransactionModel
  */
  public TransactionModel upgradeContractTrustedForwarder (String contractId, String xAuthorization, String xWalletDecryptKey, UpgradeContractTrustedForwarderRequest upgradeContractTrustedForwarderRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = upgradeContractTrustedForwarderRequest;
    // verify the required parameter 'contractId' is set
    if (contractId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'contractId' when calling upgradeContractTrustedForwarder",
        new ApiException(400, "Missing the required parameter 'contractId' when calling upgradeContractTrustedForwarder"));
    }
    // verify the required parameter 'xAuthorization' is set
    if (xAuthorization == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xAuthorization' when calling upgradeContractTrustedForwarder",
        new ApiException(400, "Missing the required parameter 'xAuthorization' when calling upgradeContractTrustedForwarder"));
    }
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling upgradeContractTrustedForwarder",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling upgradeContractTrustedForwarder"));
    }
    ...
    if (upgradeContractTrustedForwarderRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'upgradeContractTrustedForwarderRequest' when calling upgradeContractTrustedForwarder",
        new ApiException(400, "Missing the required parameter 'upgradeContractTrustedForwarderRequest' when calling upgradeContractTrustedForwarder"));
    }

    // create path and map variables
    String path = "/v1/contracts/{contractId}/forwarders".replaceAll("\\{" + "contractId" + "\\}", apiInvoker.escapeString(contractId.toString()));
   ...
   * Upgrade contract trusted forwarder
   * In rare circumstances, you may need to upgrade the underlying trusted forwarder contract address attached to your game&#39;s contracts. Using this endpoint, you can provide a new trusted forwarder contract address to assign to any of your contracts that implement the &#x60;upgradeTrustedForwarder&#x60; function.
   * @param contractId Any contract id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param upgradeContractTrustedForwarderRequest 
  */
  public void upgradeContractTrustedForwarder (String contractId, String xAuthorization, String xWalletDecryptKey, UpgradeContractTrustedForwarderRequest upgradeContractTrustedForwarderRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = upgradeContractTrustedForwarderRequest;
    ...
    // create path and map variables
    String path = "/v1/contracts/{contractId}/forwarders".replaceAll("\\{format\\}","json").replaceAll("\\{" + "contractId" + "\\}", apiInvoker.escapeString(contractId.toString()));
  ...
  * MetaFab&#39;s convenience endpoints for contract interactions may not be flexible enough depending on your use case. For these situations, you can interact with contracts and create transactions directly.  Using this endpoint, you can execute a transaction for any writeable contract method as defined in the contract&#39;s ABI for the MetaFab contractId provided. Both Games and Player resources have authority to use this endpoint to execute transactions against any valid MetaFab contractId.  Additionally, MetaFab will automatically attempt to perform a gasless transaction for players interacting with a contract through this endpoint. Gasless transactions by players through this endpoint will only work if the target contract was deployed through MetaFab or supports MetaFab&#39;s ERC2771 trusted forwarder contract.
   ...
   * @return TransactionModel
  */
  public TransactionModel writeContract (String contractId, String xAuthorization, String xWalletDecryptKey, WriteContractRequest writeContractRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling writeContract",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling writeContract"));
    }
  ...
  */
  public void writeContract (String contractId, String xAuthorization, String xWalletDecryptKey, WriteContractRequest writeContractRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = writeContractRequest;
