...
public class ContractsApi {
  ...
  */
  public TransactionModel transferContractOwnership (String contractId, String xAuthorization, String xPassword, TransferContractOwnershipRequest transferContractOwnershipRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (xPassword == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xPassword' when calling transferContractOwnership",
        new ApiException(400, "Missing the required parameter 'xPassword' when calling transferContractOwnership"));
    }
   ...
   * Transfer contract ownership
   * Transfer ownership and control of a MetaFab deployed smart contract to another wallet you control. Transferring control does not disrupt your usage of MetaFab APIs and can be done so without causing any service outages for your game. The new owner wallet will have full control over any relevant item collections and marketplace related pages this contract may be associated with, such as for MetaFab item or NFT contracts.  Your game&#39;s custodial wallet will retain a &#x60;MANAGER_ROLE&#x60; on your contracts, allowing you to still use MetaFab APIs without issue while you retain full contract ownership and the contract&#39;s administrator role. If ever you want eject from using the MetaFab APIs but still retain your deployed smart contracts, you can revoke the &#x60;MANAGER_ROLE&#x60; from your game&#39;s custodial wallet address for your contract. We do not lock you into our systems.  Please be certain that the wallet address you transfer ownership to is one you control. Once ownership and admin permissions are transferred, your game&#39;s custodial wallet no longer has permission to reassign ownership or administrative priveleges for your contract.
   * @param contractId Any contract id within the MetaFab ecosystem.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xPassword The password of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param transferContractOwnershipRequest 
  */
  public void transferContractOwnership (String contractId, String xAuthorization, String xPassword, TransferContractOwnershipRequest transferContractOwnershipRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = transferContractOwnershipRequest;
  ...
  * In rare circumstances, you may need to upgrade the underlying trusted forwarder contract address attached to your game&#39;s contracts. Using this endpoint, you can provide a new trusted forwarder contract address to assign to any of your contracts that implement the &#x60;upgradeTrustedForwarder&#x60; function.
   ...
   * @return TransactionModel
  */
  public TransactionModel upgradeContractTrustedForwarder (String contractId, String xAuthorization, String xPassword, UpgradeContractTrustedForwarderRequest upgradeContractTrustedForwarderRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xPassword' is set
    if (xPassword == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xPassword' when calling upgradeContractTrustedForwarder",
        new ApiException(400, "Missing the required parameter 'xPassword' when calling upgradeContractTrustedForwarder"));
    }
   ...
   * Upgrade contract trusted forwarder
   * In rare circumstances, you may need to upgrade the underlying trusted forwarder contract address attached to your game&#39;s contracts. Using this endpoint, you can provide a new trusted forwarder contract address to assign to any of your contracts that implement the &#x60;upgradeTrustedForwarder&#x60; function.
   * @param contractId Any contract id within the MetaFab ecosystem.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xPassword The password of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param upgradeContractTrustedForwarderRequest 
  */
  public void upgradeContractTrustedForwarder (String contractId, String xAuthorization, String xPassword, UpgradeContractTrustedForwarderRequest upgradeContractTrustedForwarderRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = upgradeContractTrustedForwarderRequest;
