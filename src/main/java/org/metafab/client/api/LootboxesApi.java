...
public class LootboxesApi {
  ...
  */
  public CreateLootboxManager200Response createLootboxManager (String xAuthorization, String xWalletDecryptKey, CreateLootboxManagerRequest createLootboxManagerRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling createLootboxManager",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling createLootboxManager"));
    }
   ...
   * Create lootbox manager
   * Creates a new game lootbox manager and deploys a lootbox manager contract on behalf of the authenticating game&#39;s primary wallet. The deployed lootbox manager contract allows you to create lootbox behavior for existing items. For example, you can define item id(s) from one of your item collections as the requirement(s) to open a \&quot;lootbox\&quot;. The required item(s) would be burned from the interacting player&#39;s wallet and the player would receive item(s) from a weighted randomized set of possible items the lootbox can contain.
   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param createLootboxManagerRequest 
  */
  public void createLootboxManager (String xAuthorization, String xWalletDecryptKey, CreateLootboxManagerRequest createLootboxManagerRequest, final Response.Listener<CreateLootboxManager200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = createLootboxManagerRequest;
  ...
  */
   ...
   * Get lootbox manager lootbox
   * Returns a lootbox manager lootbox object for the provided lootboxManagerLootboxId.
   * @param lootboxManagerId Any lootbox manager id within the MetaFab platform.   * @param lootboxManagerLootboxId Any lootbox manager lootbox id within the MetaFab platform.
  */
  ...
  */
  public List<TransactionModel> openLootboxManagerLootbox (String lootboxManagerId, String lootboxManagerLootboxId, String xAuthorization, String xWalletDecryptKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'lootboxManagerId' is set
    if (lootboxManagerId == null) {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling openLootboxManagerLootbox",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling openLootboxManagerLootbox"));
    }
   ...
   * Open lootbox manager lootbox
   * Opens a lootbox manager lootbox. The required input item(s) are burned from the wallet or player wallet opening the lootbox. The given output item(s) are given to the wallet or player wallet opening the lootbox.
   * @param lootboxManagerId Any lootbox manager id within the MetaFab platform.   * @param lootboxManagerLootboxId Any lootbox manager lootbox id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet.
  */
  public void openLootboxManagerLootbox (String lootboxManagerId, String lootboxManagerLootboxId, String xAuthorization, String xWalletDecryptKey, final Response.Listener<List<TransactionModel>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public TransactionModel removeLootboxManagerLootbox (String lootboxManagerId, String lootboxManagerLootboxId, String xAuthorization, String xWalletDecryptKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'lootboxManagerId' is set
    if (lootboxManagerId == null) {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling removeLootboxManagerLootbox",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling removeLootboxManagerLootbox"));
    }
   ...
   * Remove lootbox manager lootbox
   * Removes the provided lootbox by lootboxId from the provided lootbox manager. Removed lootboxes can no longer be used.
   * @param lootboxManagerId Any lootbox manager id within the MetaFab platform.   * @param lootboxManagerLootboxId Any lootbox manager lootbox id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.
  */
  public void removeLootboxManagerLootbox (String lootboxManagerId, String lootboxManagerLootboxId, String xAuthorization, String xWalletDecryptKey, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Sets a new lootbox manager lootbox or updates an existing one for the provided id. Lootboxes allow item(s) to be burned to receive a random set of possible item(s) based on probability weight.  Lootboxes can require any number of unique types of items and quantities to open a created lootbox type within the system. A common pattern with lootboxes is to create a lootbox item type within an item collection, and require it as the input item type.
   ...
   * @return TransactionModel
  */
  public TransactionModel setLootboxManagerLootbox (String lootboxManagerId, String xAuthorization, String xWalletDecryptKey, SetLootboxManagerLootboxRequest setLootboxManagerLootboxRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling setLootboxManagerLootbox",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling setLootboxManagerLootbox"));
    }
   ...
   * Set lootbox manager lootbox
   * Sets a new lootbox manager lootbox or updates an existing one for the provided id. Lootboxes allow item(s) to be burned to receive a random set of possible item(s) based on probability weight.  Lootboxes can require any number of unique types of items and quantities to open a created lootbox type within the system. A common pattern with lootboxes is to create a lootbox item type within an item collection, and require it as the input item type.
   * @param lootboxManagerId Any lootbox manager id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param setLootboxManagerLootboxRequest 
  */
  public void setLootboxManagerLootbox (String lootboxManagerId, String xAuthorization, String xWalletDecryptKey, SetLootboxManagerLootboxRequest setLootboxManagerLootboxRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = setLootboxManagerLootboxRequest;
