...
public class WalletsApi {
  ...
  * Creates a wallet signature from a plaintext message using the wallet for the provided walletId and walletDecryptKey. Wallet signatures cannot be generated for EOA wallets.
   ...
   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; for the provided &#x60;walletId&#x60;.
   * @param createWalletSignatureRequest 
   * @return String
  */
  public String createWalletSignature (String walletId, String xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = createWalletSignatureRequest;
    // verify the required parameter 'walletId' is set
    if (walletId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'walletId' when calling createWalletSignature",
        new ApiException(400, "Missing the required parameter 'walletId' when calling createWalletSignature"));
    }
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling createWalletSignature",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling createWalletSignature"));
    }
    // verify the required parameter 'createWalletSignatureRequest' is set
    if (createWalletSignatureRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'createWalletSignatureRequest' when calling createWalletSignature",
        new ApiException(400, "Missing the required parameter 'createWalletSignatureRequest' when calling createWalletSignature"));
    }

    // create path and map variables
    String path = "/v1/wallets/{walletId}/signatures".replaceAll("\\{" + "walletId" + "\\}", apiInvoker.escapeString(walletId.toString()));
   ...
   * Create wallet signature
   * Creates a wallet signature from a plaintext message using the wallet for the provided walletId and walletDecryptKey. Wallet signatures cannot be generated for EOA wallets.
   * @param walletId Any wallet id within the MetaFab platform.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; for the provided &#x60;walletId&#x60;.   * @param createWalletSignatureRequest 
  */
  public void createWalletSignature (String walletId, String xWalletDecryptKey, CreateWalletSignatureRequest createWalletSignatureRequest, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = createWalletSignatureRequest;
    ...
    // create path and map variables
    String path = "/v1/wallets/{walletId}/signatures".replaceAll("\\{format\\}","json").replaceAll("\\{" + "walletId" + "\\}", apiInvoker.escapeString(walletId.toString()));
  ...
  * Returns a wallet object for the provided walletId.
   ...
   * @return WalletModel
  */
  public WalletModel getWallet (String walletId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'walletId' is set
    if (walletId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'walletId' when calling getWallet",
        new ApiException(400, "Missing the required parameter 'walletId' when calling getWallet"));
    }

    // create path and map variables
    String path = "/v1/wallets/{walletId}".replaceAll("\\{" + "walletId" + "\\}", apiInvoker.escapeString(walletId.toString()));
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (WalletModel) ApiInvoker.deserialize(localVarResponse, "", WalletModel.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param walletId Any wallet id within the MetaFab platform.
  */
  public void getWallet (String walletId, final Response.Listener<WalletModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    // create path and map variables
    String path = "/v1/wallets/{walletId}".replaceAll("\\{format\\}","json").replaceAll("\\{" + "walletId" + "\\}", apiInvoker.escapeString(walletId.toString()));
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((WalletModel) ApiInvoker.deserialize(localVarResponse,  "", WalletModel.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
