...
public class GamesApi {
  ...
  */
  public UpdateGame200Response updateGame (String gameId, String xAuthorization, UpdateGameRequest updateGameRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      ...
      if (localVarResponse != null) {
         return (UpdateGame200Response) ApiInvoker.deserialize(localVarResponse, "", UpdateGame200Response.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Update game
   * Update various fields specific to a game. Such as changing its password, resetting its published or secret key, or updating its RPCs.
   * @param gameId The game id of the authenticating game.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param updateGameRequest 
  */
  public void updateGame (String gameId, String xAuthorization, UpdateGameRequest updateGameRequest, final Response.Listener<UpdateGame200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = updateGameRequest;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "PATCH", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((UpdateGame200Response) ApiInvoker.deserialize(localVarResponse,  "", UpdateGame200Response.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
