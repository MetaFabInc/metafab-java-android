...
public class ShopsApi {
  ...
  */
  public CreateShop200Response createShop (String xAuthorization, String xWalletDecryptKey, CreateShopRequest createShopRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling createShop",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling createShop"));
    }
   ...
   * Create shop
   * Creates a new game shop and deploys a shop contract on behalf of the authenticating game&#39;s primary wallet. The deployed shop contract allows you to create fixed price rates for players to buy specific items from any item collection or ERC1155 contract. Additionally, a shop allows you to create shop offers for some set of item(s) to another set of item(s) or any mix of currency. Shops completely support gasless player transactions.
   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param createShopRequest 
  */
  public void createShop (String xAuthorization, String xWalletDecryptKey, CreateShopRequest createShopRequest, final Response.Listener<CreateShop200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = createShopRequest;
  ...
  */
   ...
   * Get shop offer
   * Returns a shop offer object for the provided shopOfferId.
   * @param shopId Any shop id within the MetaFab platform.   * @param shopOfferId Any offer id for the shop. Zero, or a positive integer.
  */
  ...
  */
  public TransactionModel removeShopOffer (String shopId, String shopOfferId, String xAuthorization, String xWalletDecryptKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'shopId' is set
    if (shopId == null) {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling removeShopOffer",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling removeShopOffer"));
    }
   ...
   * Remove shop offer
   * Removes the provided offer by offerId from the provided shop. Removed offers can no longer be used.
   * @param shopId Any shop id within the MetaFab platform.   * @param shopOfferId Any offer id for the shop. Zero, or a positive integer.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.
  */
  public void removeShopOffer (String shopId, String shopOfferId, String xAuthorization, String xWalletDecryptKey, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Sets a new shop offer or updates an existing one for the provided id. Shop offers allow currency to item, item to currency or item to item exchanges.  All request fields besides &#x60;id&#x60; are optional. Any optional fields omitted will not be used for the offer. This allows you to create many different combinations of offers. For example, you can create an offer that may require 3 unique item ids of specified quantities from a given item collection and gives the user 1 new unique item id in exchange.  Another example, you may want to make a shop offer from one ERC20 token to another. This is also possible - simple set the input and output currency fields and leave the others blank.
   ...
   * @return TransactionModel
  */
  public TransactionModel setShopOffer (String shopId, String xAuthorization, String xWalletDecryptKey, SetShopOfferRequest setShopOfferRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling setShopOffer",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling setShopOffer"));
    }
   ...
   * Set shop offer
   * Sets a new shop offer or updates an existing one for the provided id. Shop offers allow currency to item, item to currency or item to item exchanges.  All request fields besides &#x60;id&#x60; are optional. Any optional fields omitted will not be used for the offer. This allows you to create many different combinations of offers. For example, you can create an offer that may require 3 unique item ids of specified quantities from a given item collection and gives the user 1 new unique item id in exchange.  Another example, you may want to make a shop offer from one ERC20 token to another. This is also possible - simple set the input and output currency fields and leave the others blank.
   * @param shopId Any shop id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param setShopOfferRequest 
  */
  public void setShopOffer (String shopId, String xAuthorization, String xWalletDecryptKey, SetShopOfferRequest setShopOfferRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = setShopOfferRequest;
  ...
  * Uses a shop offer. The required (input) item(s) and/or currency are removed from the wallet or player wallet using the offer. The given (output) item(s) and/or currency are given to the wallet or player wallet using the offer.
   ...
   * @return TransactionModel
  */
  public TransactionModel useShopOffer (String shopId, String shopOfferId, String xAuthorization, String xWalletDecryptKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'shopId' is set
    if (shopId == null) {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling useShopOffer",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling useShopOffer"));
    }
   ...
   * Use shop offer
   * Uses a shop offer. The required (input) item(s) and/or currency are removed from the wallet or player wallet using the offer. The given (output) item(s) and/or currency are given to the wallet or player wallet using the offer.
   * @param shopId Any shop id within the MetaFab platform.   * @param shopOfferId Any offer id for the shop. Zero, or a positive integer.   * @param xAuthorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet.
  */
  public void useShopOffer (String shopId, String shopOfferId, String xAuthorization, String xWalletDecryptKey, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Withdraws native token, currency or items from a shop. Whenever a shop offer has input requirements, the native tokens, currencies or items for the requirements of that offer are deposited into the shop contract when the offer is used. These can be withdrawn to any other address.
   ...
   * @return TransactionModel
  */
  public TransactionModel withdrawFromShop (String shopId, String xAuthorization, String xWalletDecryptKey, WithdrawFromShopRequest withdrawFromShopRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling withdrawFromShop",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling withdrawFromShop"));
    }
   ...
   * Withdraw from shop
   * Withdraws native token, currency or items from a shop. Whenever a shop offer has input requirements, the native tokens, currencies or items for the requirements of that offer are deposited into the shop contract when the offer is used. These can be withdrawn to any other address.
   * @param shopId Any shop id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param withdrawFromShopRequest 
  */
  public void withdrawFromShop (String shopId, String xAuthorization, String xWalletDecryptKey, WithdrawFromShopRequest withdrawFromShopRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = withdrawFromShopRequest;
