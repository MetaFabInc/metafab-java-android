...
public class ItemsApi {
  ...
  * Returns a boolean (true/false) representing if the provided operatorAddress has approval to transfer and burn items from the current collection owned by the address or address associated with the provided walletId.
   ...
   * @return BigDecimal
  */
  public BigDecimal getCollectionApproval (String collectionId, String operatorAddress, String address, String walletId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void getCollectionApproval (String collectionId, String operatorAddress, String address, String walletId, final Response.Listener<BigDecimal> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns a metadata object for the provided collectionItemId.
   ...
   * @return List<Object>
  */
  public List<Object> getCollectionItem (String collectionId, BigDecimal collectionItemId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
  ...
  */
  public void getCollectionItem (String collectionId, BigDecimal collectionItemId, final Response.Listener<List<Object>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
