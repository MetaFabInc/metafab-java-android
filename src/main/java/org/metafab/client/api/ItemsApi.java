...
public class ItemsApi {
  ...
  * Creates (mints) the provided itemIds of the specified quantities to the provided wallet address or wallet address associated with the provided walletId.
   ...
   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.
   * @param batchMintCollectionItemsRequest 
   * @return TransactionModel
  */
  public TransactionModel batchMintCollectionItems (String collectionId, String xAuthorization, String xWalletDecryptKey, BatchMintCollectionItemsRequest batchMintCollectionItemsRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling batchMintCollectionItems",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling batchMintCollectionItems"));
    }
   ...
   * Batch mint collection items
   * Creates (mints) the provided itemIds of the specified quantities to the provided wallet address or wallet address associated with the provided walletId.
   * @param collectionId Any collection id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param batchMintCollectionItemsRequest 
  */
  public void batchMintCollectionItems (String collectionId, String xAuthorization, String xWalletDecryptKey, BatchMintCollectionItemsRequest batchMintCollectionItemsRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = batchMintCollectionItemsRequest;
  ...
  * Transfers one or multiple items of specified quantities to the provided wallet addresses or wallet addresses associated with the provided walletIds. You may also provide a combination of addresses and walletIds in one request.
   ...
   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet.
   * @param batchTransferCollectionItemsRequest 
   * @return TransactionModel
  */
  public TransactionModel batchTransferCollectionItems (String collectionId, String xAuthorization, String xWalletDecryptKey, BatchTransferCollectionItemsRequest batchTransferCollectionItemsRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling batchTransferCollectionItems",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling batchTransferCollectionItems"));
    }
   ...
   * Batch transfer collection items
   * Transfers one or multiple items of specified quantities to the provided wallet addresses or wallet addresses associated with the provided walletIds. You may also provide a combination of addresses and walletIds in one request.
   * @param collectionId Any collection id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet.   * @param batchTransferCollectionItemsRequest 
  */
  public void batchTransferCollectionItems (String collectionId, String xAuthorization, String xWalletDecryptKey, BatchTransferCollectionItemsRequest batchTransferCollectionItemsRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = batchTransferCollectionItemsRequest;
  ...
  * Removes (burns) the provided quantity of the collectionItemId from the authenticating game or players wallet. The quantity is permanently removed from the circulating supply of the item.
   ...
   * @return TransactionModel
  */
  public TransactionModel burnCollectionItem (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, BurnCollectionItemRequest burnCollectionItemRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling burnCollectionItem",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling burnCollectionItem"));
    }
   ...
   * Burn collection item
   * Removes (burns) the provided quantity of the collectionItemId from the authenticating game or players wallet. The quantity is permanently removed from the circulating supply of the item.
   * @param collectionId Any collection id within the MetaFab platform.   * @param collectionItemId Any item id for the collection. Zero, or a positive integer.   * @param xAuthorization The &#x60;secretKey&#x60; of a specific game or the &#x60;accessToken&#x60; of a specific player.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game or player. Required to decrypt and perform blockchain transactions with the game or player primary wallet.   * @param burnCollectionItemRequest 
  */
  public void burnCollectionItem (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, BurnCollectionItemRequest burnCollectionItemRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = burnCollectionItemRequest;
  ...
  */
  public CreateCollection200Response createCollection (String xAuthorization, String xWalletDecryptKey, CreateCollectionRequest createCollectionRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling createCollection",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling createCollection"));
    }
   ...
   * Create collection
   * Creates a new game item collection and deploys an extended functionality ERC1155 contract on behalf of the authenticating game&#39;s primary wallet. The deployed ERC1155 contract is preconfigured to fully support creating unique item types, item transfer timelocks, custom metadata per item, gasless transactions from player managed wallets, and much more.
   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param createCollectionRequest 
  */
  public void createCollection (String xAuthorization, String xWalletDecryptKey, CreateCollectionRequest createCollectionRequest, final Response.Listener<CreateCollection200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = createCollectionRequest;
  ...
  * Creates a new item type. Item type creation associates all of the relevant item data to a specific itemId. Such as item name, image, description, attributes, any arbitrary data such as 2D or 3D model resolver URLs, and more. It is recommended, but not required, that you create a new item type through this endpoint before minting any quantity of the related itemId.  Any itemId provided will have its existing item type overriden if it already exists.  Item type data is uploaded to, and resolved through IPFS for decentralized persistence.
   ...
   * @return TransactionModel
  */
  public TransactionModel createCollectionItem (String collectionId, String xAuthorization, String xWalletDecryptKey, CreateCollectionItemRequest createCollectionItemRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling createCollectionItem",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling createCollectionItem"));
    }
   ...
   * Create collection item
   * Creates a new item type. Item type creation associates all of the relevant item data to a specific itemId. Such as item name, image, description, attributes, any arbitrary data such as 2D or 3D model resolver URLs, and more. It is recommended, but not required, that you create a new item type through this endpoint before minting any quantity of the related itemId.  Any itemId provided will have its existing item type overriden if it already exists.  Item type data is uploaded to, and resolved through IPFS for decentralized persistence.
   * @param collectionId Any collection id within the MetaFab platform.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param createCollectionItemRequest 
  */
  public void createCollectionItem (String collectionId, String xAuthorization, String xWalletDecryptKey, CreateCollectionItemRequest createCollectionItemRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = createCollectionItemRequest;
  ...
  */
   ...
   * Get collection approval
   * Returns a boolean (true/false) representing if the provided operatorAddress has approval to transfer and burn items from the current collection owned by the address or address associated with the provided walletId.
   * @param collectionId Any collection id within the MetaFab platform.   * @param operatorAddress A valid EVM based address. For example, &#x60;0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D&#x60;.   * @param address A valid EVM based address. For example, &#x60;0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D&#x60;.   * @param walletId Any wallet id within the MetaFab platform.
  */
  ...
  */
  public CollectionItem getCollectionItem (String collectionId, BigDecimal collectionItemId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (CollectionItem) ApiInvoker.deserialize(localVarResponse, "", CollectionItem.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * Get collection item
   * Returns a metadata object for the provided collectionItemId.
   * @param collectionId Any collection id within the MetaFab platform.   * @param collectionItemId Any item id for the collection. Zero, or a positive integer.
  */
  public void getCollectionItem (String collectionId, BigDecimal collectionItemId, final Response.Listener<CollectionItem> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((CollectionItem) ApiInvoker.deserialize(localVarResponse,  "", CollectionItem.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Returns the current collection item balance of the provided collectionItemId for the provided wallet address or the wallet address associated with the provided walletId.
   ...
   * @return Integer
  */
  public Integer getCollectionItemBalance (String collectionId, BigDecimal collectionItemId, String address, String walletId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
   ...
   * Get collection item balance
   * Returns the current collection item balance of the provided collectionItemId for the provided wallet address or the wallet address associated with the provided walletId.
   * @param collectionId Any collection id within the MetaFab platform.   * @param collectionItemId Any item id for the collection. Zero, or a positive integer.   * @param address A valid EVM based address. For example, &#x60;0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D&#x60;.   * @param walletId Any wallet id within the MetaFab platform.
  */
  public void getCollectionItemBalance (String collectionId, BigDecimal collectionItemId, String address, String walletId, final Response.Listener<Integer> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public Map<String, Integer> getCollectionItemBalances (String collectionId, String address, String walletId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
   ...
   * Get collection item balances
   * Returns the current collection item balances of all collection items for the provided wallet address or the wallet address associated with the provided walletId.
   * @param collectionId Any collection id within the MetaFab platform.   * @param address A valid EVM based address. For example, &#x60;0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D&#x60;.   * @param walletId Any wallet id within the MetaFab platform.
  */
  public void getCollectionItemBalances (String collectionId, String address, String walletId, final Response.Listener<Map<String, Integer>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns the currency circulating supply of all collection items.
   ...
   * @return Map<String, Integer>
  */
  public Map<String, Integer> getCollectionItemSupplies (String collectionId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
   ...
   * @param collectionId Any collection id within the MetaFab platform.
  */
  public void getCollectionItemSupplies (String collectionId, final Response.Listener<Map<String, Integer>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns the current circulating supply of the provided collectionItemId.
   ...
   * @return Integer
  */
  public Integer getCollectionItemSupply (String collectionId, BigDecimal collectionItemId, String address, String walletId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
   ...
   * @param collectionId Any collection id within the MetaFab platform.   * @param collectionItemId Any item id for the collection. Zero, or a positive integer.   * @param address A valid EVM based address. For example, &#x60;0x39cb70F972E0EE920088AeF97Dbe5c6251a9c25D&#x60;.   * @param walletId Any wallet id within the MetaFab platform.
  */
  public void getCollectionItemSupply (String collectionId, BigDecimal collectionItemId, String address, String walletId, final Response.Listener<Integer> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * Returns a timestamp (in seconds) for when the provided collectionItemId&#39;s transfer timelock expires. A value of 0 means the provided collectionItemId does not have a timelock set. Timelocks prevent items of a specific collectionItemId from being transferred until the set timelock timestamp has been surpassed.
   ...
   * @return Integer
  */
  public Integer getCollectionItemTimelock (String collectionId, BigDecimal collectionItemId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
   ...
   * @param collectionId Any collection id within the MetaFab platform.   * @param collectionItemId Any item id for the collection. Zero, or a positive integer.
  */
  public void getCollectionItemTimelock (String collectionId, BigDecimal collectionItemId, final Response.Listener<Integer> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public List<CollectionItem> getCollectionItems (String collectionId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'collectionId' is set
    if (collectionId == null) {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (List<CollectionItem>) ApiInvoker.deserialize(localVarResponse, "array", CollectionItem.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
   ...
   * @param collectionId Any collection id within the MetaFab platform.
  */
  public void getCollectionItems (String collectionId, final Response.Listener<List<CollectionItem>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((List<CollectionItem>) ApiInvoker.deserialize(localVarResponse,  "array", CollectionItem.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * Grants the provided role for the collection to the provided address or address associated with the provided walletId. Granted roles give different types of authority on behalf of the collection for specific players, addresses, or contracts to perform different types of permissioned collection operations.
   ...
   * @return TransactionModel
  */
  public TransactionModel grantCollectionRole (String collectionId, String xAuthorization, String xWalletDecryptKey, GrantCollectionRoleRequest grantCollectionRoleRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling grantCollectionRole",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling grantCollectionRole"));
    }
  ...
  */
  public void grantCollectionRole (String collectionId, String xAuthorization, String xWalletDecryptKey, GrantCollectionRoleRequest grantCollectionRoleRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = grantCollectionRoleRequest;
  ...
  * Creates (mints) the specified quantity of the provided collectionItemId to the provided wallet address or wallet address associated with the provided walletId.
   ...
   * @return TransactionModel
  */
  public TransactionModel mintCollectionItem (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, MintCollectionItemRequest mintCollectionItemRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling mintCollectionItem",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling mintCollectionItem"));
    }
   ...
   * Mint collection item
   * Creates (mints) the specified quantity of the provided collectionItemId to the provided wallet address or wallet address associated with the provided walletId.
   * @param collectionId Any collection id within the MetaFab platform.   * @param collectionItemId Any item id for the collection. Zero, or a positive integer.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param mintCollectionItemRequest 
  */
  public void mintCollectionItem (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, MintCollectionItemRequest mintCollectionItemRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = mintCollectionItemRequest;
  ...
  * Revokes the provided role for the collection to the provided address or address associated with the provided walletId.
   ...
   * @return TransactionModel
  */
  public TransactionModel revokeCollectionRole (String collectionId, String xAuthorization, String xWalletDecryptKey, RevokeCollectionRoleRequest revokeCollectionRoleRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling revokeCollectionRole",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling revokeCollectionRole"));
    }
  ...
  */
  public void revokeCollectionRole (String collectionId, String xAuthorization, String xWalletDecryptKey, RevokeCollectionRoleRequest revokeCollectionRoleRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = revokeCollectionRoleRequest;
  ...
  * Sets approval for the provided address or wallet address associated with the provided walletId to operate on behalf of the authenticating game or player&#39;s owned items for this collection. Setting an approved value of &#x60;true&#x60; allows the provided address or address associated with the provided walletId to transfer and burn items from this collection on behalf of the authenticated game or player&#39;s wallet address.
   ...
   * @return TransactionModel
  */
  public TransactionModel setCollectionApproval (String collectionId, String xAuthorization, String xWalletDecryptKey, SetCollectionApprovalRequest setCollectionApprovalRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling setCollectionApproval",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling setCollectionApproval"));
    }
  ...
  */
  public void setCollectionApproval (String collectionId, String xAuthorization, String xWalletDecryptKey, SetCollectionApprovalRequest setCollectionApprovalRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = setCollectionApprovalRequest;
  ...
  * Sets the item timelock for the provided collection itemId. The timelock is a unix timestamp (in seconds) that defines a period in time of when an item may be transferred by players. Until the timelock timestamp has passed, the itemId for the given timelock may not be transferred, sold, traded, etc. A timelock of 0 (default) means that there is no timelock set on the itemId and it can be freely transferred, traded, etc.
   ...
   * @return TransactionModel
  */
  public TransactionModel setCollectionItemTimelock (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, SetCollectionItemTimelockRequest setCollectionItemTimelockRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling setCollectionItemTimelock",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling setCollectionItemTimelock"));
    }
   ...
   * Set collection item timelock
   * Sets the item timelock for the provided collection itemId. The timelock is a unix timestamp (in seconds) that defines a period in time of when an item may be transferred by players. Until the timelock timestamp has passed, the itemId for the given timelock may not be transferred, sold, traded, etc. A timelock of 0 (default) means that there is no timelock set on the itemId and it can be freely transferred, traded, etc.
   * @param collectionId Any collection id within the MetaFab platform.   * @param collectionItemId Any item id for the collection. Zero, or a positive integer.   * @param xAuthorization The &#x60;secretKey&#x60; of the authenticating game.   * @param xWalletDecryptKey The &#x60;walletDecryptKey&#x60; of the authenticating game. Required to decrypt and perform blockchain transactions with the game primary wallet.   * @param setCollectionItemTimelockRequest 
  */
  public void setCollectionItemTimelock (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, SetCollectionItemTimelockRequest setCollectionItemTimelockRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = setCollectionItemTimelockRequest;
  ...
  * Transfers specified quantity of itemId to the provided wallet address or wallet address associated with the provided walletId.
   ...
   * @return TransactionModel
  */
  public TransactionModel transferCollectionItem (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, TransferCollectionItemRequest transferCollectionItemRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    // verify the required parameter 'xWalletDecryptKey' is set
    if (xWalletDecryptKey == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'xWalletDecryptKey' when calling transferCollectionItem",
        new ApiException(400, "Missing the required parameter 'xWalletDecryptKey' when calling transferCollectionItem"));
    }
  ...
  */
  public void transferCollectionItem (String collectionId, BigDecimal collectionItemId, String xAuthorization, String xWalletDecryptKey, TransferCollectionItemRequest transferCollectionItemRequest, final Response.Listener<TransactionModel> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = transferCollectionItemRequest;
