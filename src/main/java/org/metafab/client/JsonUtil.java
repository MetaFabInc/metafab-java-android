...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("CreateCollectionItemRequestAttributesInnerValue".equalsIgnoreCase(className)) {
      return new TypeToken<List<CreateCollectionItemRequestAttributesInnerValue>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("CreateCollectionItemRequestAttributesInnerValue".equalsIgnoreCase(className)) {
      return new TypeToken<CreateCollectionItemRequestAttributesInnerValue>(){}.getType();
    }
